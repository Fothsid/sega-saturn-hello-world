...
#define VDP2_VRAM ((volatile u16*) 0x25F80000)
...
//
// d -> display switch
// b -> TV border (0 - black, 1 - color)
// i -> interlace (0 - no interlace, 2 - single interlace, 3 - double interlace)
// v -> vertical resolution (0 - 224, 1 - 240, 2 - 256)
// h -> horizontal resolution (320, 352, 640, 704, 320e, 352e, 640e, 704e)
//
// 320x240 non-interlaced = 0x8010
//

#define TV_320_240_NI (0x8010)
...
//
// Taken straight from Yabause source code
//
typedef struct {
	 u16 TVMD;   // 0x25F80000
...
#define VDP2 ((volatile _VDP2REGS*) 0x25F80000)